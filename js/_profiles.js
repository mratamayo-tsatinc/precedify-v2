...
const PROFILES_RAW = [
  ...
  },
  {
    ...
    operators:{allowed:OPS.ARITH_BASIC}, template:'operand low operand high operand',
  ...
  },
  {
    ...
    operators:{allowed:OPS.ARITH_BASIC}, template:'operand high (operand low operand)',
